...
public class AttendaceService {
    ...
    public Attendance updateAttendanceStatusByEmployeeAndDate(int empId, String date, String newStatus) {
        List<Attendance> attendances = attendanceRepo.findByEmployeeEmpIdAndDateBetween(empId, date, date);
        if (attendances.isEmpty()) {
            throw new IllegalArgumentException(
                    "No attendance record found for employee id " + empId + " on date " + date);
        }
    ...
    public List<Attendance> getAttendanceByEmployeeName(String firstName, String lastName) {
        // This method can be implemented by joining with employee records.
